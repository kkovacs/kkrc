...
printf '\r grep PRETTY_NAME /etc/os-release;uname -prinsm;uptime;free -mwt;history 12;tmux list-sessions;systemd-detect-virt;echo export SSH_AUTH_SOCK=$SSH_AUTH_SOCK\r' >>../inject-bash.txt
