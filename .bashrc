...
# opencode run. NOTE: using $* deliberately. O is for "plan", OO is for "build"
function O() { opencode -m opencode/big-pickle --agent plan run "$*" ; }
function OO() { opencode -m opencode/big-pickle run "$*" ; }
